...
CFGFLAGS ?= --enable-java --enable-gtk-doc WARN_CFLAGS="-Werror -Wno-error=sign-conversion -Wno-error=conversion -Wno-error=traditional-conversion -Wno-error=missing-noreturn -Wno-error=logical-op"
