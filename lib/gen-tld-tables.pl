...
else # Default run.
{
	...
	foreach my $tld (@files)
	{
		...
		print_tld_domain($tld, \@singles, \@intervals, $vermaj, $vermin);
	}
	closedir(DIR);

	print "\n\n";
	print "/* Main array */\n\n";
	print "const TLDCHK_domain * tldchk_domains[] =\n";
	print "{\n";
	foreach (@tlds)
	{
		print " &__${_}_domain,\n";
...
# void print_tld_domain($tld, \@singles, \@intervals, $vermaj, $vermin);
sub print_tld_domain
{
	...
	print "\n\n";
	print "/* TLD $tld */\n\n";
	print "const uint32_t __${tld}_singles[] =\n";
	print "{\n";
	...
	print "const uint32_t __${tld}_intervals[] =\n";
	print "{\n";
	...
	print "const TLDCHK_domain __${tld}_domain =\n";
	print "{\n";
	print " \"$tld\",\n";
	print " $vermaj,\n";
	print " $vermin, \n";
	print " $num_singles,\n";
	print " $num_intervals,\n";
	print " __${tld}_singles,\n";
	print " __${tld}_intervals\n";
	print "};\n";
}
