/* tst_idna.c	Libstringprep self tests for idna_to_ascii().
...
idna[] =
{
  ...
  ,
  {
    ...
    0, 0, IDNA_PUNYCODE_ERROR} /* too long output */
  ,
  {
  ...
  ,
  {
    ...
    , IDNA_ACE_PREFIX "de-jg4avhby1noc0d", 0, 0, IDNA_SUCCESS}
  ,
  {
    "(R) <sono><supiido><de>", 7,
    {
      0x305D, 0x306E, 0x30B9, 0x30D4, 0x30FC, 0x30C9, 0x3067}
    , IDNA_ACE_PREFIX "d9juau41awczczp", 0, 0, IDNA_SUCCESS}
  ,
#if 0
  {
    "(S) -> $1.00 <-", 11,
    ...
    , IDNA_ACE_PREFIX "-> $1.00 <--", 0, 0, IDNA_SUCCESS}
#endif
};
