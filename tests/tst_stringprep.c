...
strprep[] =
{
  ...
  {
  "Case map + normalization", "\xC2\xB5", "\xCE\xBC", "generic"},
    /* The rest are rather non-interesting, but no point in removing
       working test cases... */
  {
  "case_nonfkc", "\xC2\xB5", "\xCE\xBC", "generic", STRINGPREP_NO_NFKC}
  ,
  {
  "NFKC test", "\xC2\xAA", "\x61", "generic"},
  {
  "nameprep, exposed a bug in libstringprep 0.0.5",
      "\xC2\xAA\x0A", "\x61\x0A"},
  {
  "unassigned code point U+0221", "\xC8\xA1", "\xC8\xA1", "generic"},
  {
  "Unassigned code point U+0221",
      "\xC8\xA1", NULL, "generic", STRINGPREP_NO_UNASSIGNED,
      STRINGPREP_CONTAINS_UNASSIGNED},
  {
  "Unassigned code point U+0236", "\xC8\xB6", "\xC8\xB6", "generic"},
  {
